...
| 027 | Preparação e publicação do repositório (higiene de repositório / infraestrutura de portfólio) | fora de fase | 🔄 Blocos 0–4 concluídos (auditoria, backup/rotação de credenciais, reescrita de histórico, seed Rede Vale Verde, correções de produto, vitrine); Blocos 5 (travas) e 6 (publicação) pendentes — repositório segue **privado** | ADR-012 aceito |
