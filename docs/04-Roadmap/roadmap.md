...
| 026 | Handler de `push`/`notificationclick` no service worker (nunca existiu — fecha a lacuna de medição real que mantém o INC-012 em 🟡) + fim do catch mudo em `push-channel.ts` | correção (pré-piloto) | 🔄 em andamento | 012 · 025 |
