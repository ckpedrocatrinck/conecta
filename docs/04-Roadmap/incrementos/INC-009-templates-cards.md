...
## Escopo
1. Template HTML/CSS por tipo: reconhecimento, tempo de casa (X anos), promoção (cargo novo), aniversariante, vaga. Identidade visual configurável por tenant (logo + 2 cores).
