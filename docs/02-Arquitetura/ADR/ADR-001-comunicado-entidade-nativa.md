...
## Contexto
Na portal legado, comunicados são imagens escaneadas (com assinatura) embutidas em página web: sem busca, ilegíveis no celular, inacessíveis, impossíveis de versionar. A confirmação "declaro que li e entendi" existe, mas sem vínculo com o conteúdo exato lido nem relatório de pendências utilizável. O valor jurídico do sistema depende de provar QUEM confirmou O QUÊ e QUANDO.
...
- **Upload de imagem/PDF como a portal legado** — preserva o fluxo atual do RH, mas perpetua todos os problemas; rejeitada.
...
− Migração do histórico da portal legado (imagens) não é 1:1; histórico legado pode entrar como anexo-arquivo morto.
