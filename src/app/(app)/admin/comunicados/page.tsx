  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link href="/admin/comunicados/novo" className={buttonVariants({ variant: "default", size: "touch" })}>
      ...
      <form className="flex flex-col gap-3 sm:flex-row sm:items-center" action="/admin/comunicados">
        <Input
          type="search"
          name="q"
          defaultValue={q}
