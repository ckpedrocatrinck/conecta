    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Link href="/admin/colaboradores/importar" className={buttonVariants({ variant: "outline", size: "touch" })}>
            <Upload aria-hidden="true" />
            Importar CSV
          </Link>
          <Link href="/admin/colaboradores/novo" className={buttonVariants({ variant: "default", size: "touch" })}>
